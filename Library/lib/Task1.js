"use strict";
module.exports = function perimeterAndArea(a, b, c) {
    ...
    function perimeter(highBasicOfTrapezium, lowBasicOfTrapezium, BasicsOfTrapezium) {
        let P = highBasicOfTrapezium + lowBasicOfTrapezium + BasicsOfTrapezium * 2;
        return P;
    }
    ;
    // calculation the area of the trapezium
    function area(highBasicOfTrapezium, lowBasicOfTrapezium, BasicsOfTrapezium) {
