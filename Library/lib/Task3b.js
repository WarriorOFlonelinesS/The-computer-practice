"use strict";
module.exports = function incomesOfGroups(group) {
    if (group == 'А') {
        // calculation of full incomes withon taxes
        let full = 100 * Math.abs(Math.sin(4) * Math.cos(Math.pow(4, 2) * Math.sin(4 + 1.4) + 5.14) + 54);
        // calculation of full icomes with taxes
...
//# sourceMappingURL=Task3b.js.map